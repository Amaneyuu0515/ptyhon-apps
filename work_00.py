...
def good_ending():
    ...
    chat_line("あなた「全ては、争いのないセカイのために」")
    chat_line("魔王「、、、そうだな、我らは共に新しい世界を築くのだ。」")
    chat_line("魔王「全軍、突撃せよ！！」")
    chat_line("魔物たちは人間の国へと攻め込み、全てを征服した。")
    chat_line("人間はあなた以外あなた以外一人もいなくなった")
    chat_line("世界に争いはなくなり、魔物が蔓延る世界となった。")
    chat_line("リリアンヌ「、、、これが、あなたの望む世界。」")
    chat_line("あなた「、、、うん、これが俺の望む世界だよ。」")
    chat_line("リリアンヌ「、、、あなたが、そういうなら、私もついていくわ。」")
